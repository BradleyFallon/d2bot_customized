...
function LoadConfig() {
	...
	*/
	...
	//Config.QuitList = ["hotfuz"]; // List of character names to quit with. Example: //Config.QuitList = ["MySorc", "MyDin"];
	 ...
	 */
	Config.AttackSkill[0] = 144; // Preattack skill.
	Config.AttackSkill[1] = 151; // Primary skill for bosses.
	Config.AttackSkill[2] = 132; // Backup/Immune skill for bosses.
	Config.AttackSkill[3] = 151; // Primary skill for others.
	Config.AttackSkill[4] = 132; // Backup/Immune skill for others.
