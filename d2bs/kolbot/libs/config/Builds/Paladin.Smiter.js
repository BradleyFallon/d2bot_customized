...
var AutoBuildTemplate = {
	...
	2:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength + 1, Vitality + 4 (26) (29)
			Update: function () {
	...
	3:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength 3, Vitality + 3 (28) (32)
			Update: function () {
	...
	4:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength 6+25, Vitality + 2 (31) (34)
			Update: function () {
	...
	5:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength 10+25, Vitality + 1 (35) (35)
			Update: function () {
	...
	6:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength 12+25, Vitality + 3 (37) (38)
			Update: function () {
	...
	7:	{
			SkillPoints: [-1],											// Save Point + 1 (1 saved point remains)
			StatPoints: [0, 0, 0, 0, 0],								// Strength 14+25, Vitality + 3 (39) (41)
			Update: function () {
	...
	8:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Strength 15+25, Vitality + 4 (40) (45)
			Update: function () {
	...
	9:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Vitality + 5 (50)
			Update: function () {
	...
	10:	{
			...
			StatPoints: [0, 0, 0, 0, 0],								// Vitality + 5 (55)
			Update: function () {
	...
	18:	{
			SkillPoints: [97, 113, 115],								// Blessed Hammer + 1, Concentration + 1, Vigor + 1 (level 1) (level 1) (level 1) (6 saved points remain)
			StatPoints: [3, 3, 3, 3, 3],								// Vitality + 5 (95)
			Update: function () {
				Config.AttackSkill = [-1, 97, 113, 97, 113, 101, 113];// Blessed Hammer and Concentration!
	...
	19:	{
			SkillPoints: [97, 113],									// Blessed Hammer + 1, Concentration + 1 (level 2) (level 2) (5 saved points remain)
	...
	20:	{
			SkillPoints: [97, 113],									// Blessed Hammer + 1, Concentration + 1 (level 3) (level 3) (4 saved points remain)
	...
	21:	{	
			SkillPoints: [97, 113],									// Blessed Hammer + 1, Concentration + 1 (level 4) (level 4) (3 saved points remain)
	...
	22:	{
			SkillPoints: [97, 113],									// Blessed Hammer + 1, Concentration + 1 (level 5) (level 5) (2 saved points remain)
	...
	23:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 6) (2 saved points remain)
	...
	24:	{
			SkillPoints: [97, 117, 120],								// Blessed Hammer + 1, Holy Shield + 1, Meditation + 1 (level 7) (level 1) (level 1) (0 saved points remain)
			StatPoints: [3, 3, 3, 3, 3],								// Vitality + 5 (125)
			Update: function () {
				Config.AttackSkill = [-1, 97, 113, 97, 113, 101, 120];// Holy Bolt and Meditation for Secondary Skill/Aura.
	...
	25:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 8)
	...
	26:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 9)
	...
	27:	{
			SkillPoints: [97, 108],									// Blessed Hammer + 1, Blessed Aim + 1 (level 10) (level 3) (Norm Radament)
	...
	28:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 11)
	...
	29:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 12)
	...
	30:	{
			SkillPoints: [97, 108, 122],								// Blessed Hammer + 1, Blessed Aim + 2 (level 13) (level 5) (Norm Izual)
			StatPoints: [3, 3, 3, 3, 3, 3, 3, 3, 3, 3],					// Vitality + 10 (160) (Norm Lam Esen's Tome)
			Update: function () {
				Config.AttackSkill = [-1, 97, 113, 97, 113, 97, 122];// Holy Bolt and Meditation for Secondary Skill/Aura.
				Config.LowGold = 20000;
			}
		},

	31:	{	
			SkillPoints: [97],											// Blessed Hammer + 1 (level 14)
	...
	32:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 15)
	...
	33:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 16)
	...
	34:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 17)
	...
	35:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 18)
	...
	36:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 19)
	...
	37:	{
			SkillPoints: [97],											// Blessed Hammer + 1 (level 20)
