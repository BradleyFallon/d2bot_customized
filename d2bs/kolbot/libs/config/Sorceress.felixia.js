...
function LoadConfig() {
	...
	Scripts.AutoSmurf = false;
		...
		Config.AutoSmurf.OtherChars = ["felixdin"]; // all team charnames, excluding the leader and boBarb
		Config.AutoSmurf.AllTeamProfiles = ["USWestSorc", "rushee"]; // the whole team PROFILE names
	...
	*/
	...
	Config.QuitList = ["sparktrap", "felixdin"]; // List of character names to quit with. Example: //Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.AttackSkill[6] = 38; // Secondary untimed skill if monster is immune to primary untimed.
	...
	Config.StaticList = ["Griswold", /*"Gargoyle Trap", */"Andariel", "Duriel", "Izual", "Diablo", "Baal", "Mephisto", "Venom Lord", "Minon Of Destruction", "The Countess"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
