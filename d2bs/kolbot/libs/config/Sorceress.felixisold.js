...
function LoadConfig() {
	...
	*/
	...
	Config.Leader = "felixia"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	//Config.QuitList = ["sparktrap"]; // List of character names to quit with. Example: //Config.QuitList = ["MySorc", "MyDin"];
	...
	Config.CainID.MinGold = 1000000; // Minimum gold (stash + character) to have in order to use Cain.
	...
	// Config.KeepRunewords.push("[type] == staff # [itemallskills] == 2");
	...
	Config.StaticList = ["Lister The Tormentor", "Countess","Andariel","Radament","Duriel","Izual","Diablo","Shenk","Baal"];
