...
function LoadConfig() {
	...
	*/
	...
	Config.UseRejuvHP = 70;  // Drink a rejuvenation potion if life is under designated percent.
	...
	Config.RejuvBuffer = 6; // Number of rejuvenation potions to keep in inventory.
	...
	// Config.PickitFiles.push("autosmurf/necromancer.xpac.nip");
	...
	Config.AttackSkill[4] = 78; // Primary untimed skill to others. Keep at -1 if Config.AttackSkill[3] is untimed skill.
	...
	Config.AutoBuild.Template = "Summon";	//	The name of the build associated with an existing
