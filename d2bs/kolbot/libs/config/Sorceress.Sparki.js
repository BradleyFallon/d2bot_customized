...
function LoadConfig() {
	...
	*/
	...
	Scripts.OrgTorch = false;
		...
		Config.OrgTorch.WaitTimeout = 0; // Time in minutes to wait for keys before moving on
	...
	Config.GambleItems.push("Grand Charm");
	...
	// *** Dual element - frozen orb + meteor (with glacial spike to lightning immune)
	...
	// Config.AttackSkill[3] = 64; // Primary skill to others.
	// Config.AttackSkill[4] = 56; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[3] is untimed skill.
	// Config.AttackSkill[5] = -1; // Secondary skill if monster is immune to primary.
