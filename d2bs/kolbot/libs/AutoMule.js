var AutoMule = {
	Mules: {
		"Mule1":  {
			...
			accountPrefix: "skwizalt",  // Account prefix. Numbers added automatically when making accounts.
			accountPassword: "tukieh123",  // Account password.
			charPrefix: "skwizmule",  // Character prefix. Suffix added automatically when making characters.
			...
			muleGameName: ["skwizflops", "tukieh"], // ["gamename", "password"]

			// List of profiles that will mule items. Example: enabledProfiles: ["profile 1", "profile 2"],
			enabledProfiles: ["USWestSorc", "NMSorc", "smiter", "sparktrap"],
	...
	*/
	TorchAnniMules: {
		"Mule1":  {
			...
			// Game name and password of the mule game. Never use the same game name as for mule logger.
			muleGameName: ["skwizflops", "fds"], // ["gamename", "password"]

			// List of profiles that will mule items. Example: enabledProfiles: ["profile 1", "profile 2"],
			enabledProfiles: ["smiter"],
			stopProfileKeyRelease: true, // true = stopProfile key will get released on stop. useful when using 100% of your keys for botting.
